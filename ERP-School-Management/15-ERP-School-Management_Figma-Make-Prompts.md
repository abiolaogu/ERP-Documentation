...
```
Design a control plane view for ERP-School-Management that shows:
...
```
Generate a role-aware workspace for ERP-School-Management with:
...
```
Design a full incident-response flow for ERP-School-Management:
...
```
Create mobile and tablet executive dashboards for ERP-School-Management:
...
```
Create a Make scenario for ERP-School-Management that:
...
```
Generate a Make scenario for tenant onboarding in ERP-School-Management:
