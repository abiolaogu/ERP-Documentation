...
```
Design a control plane view for ERP-Commerce that shows:
...
```
Generate a role-aware workspace for ERP-Commerce with:
...
```
Design a full incident-response flow for ERP-Commerce:
...
```
Create mobile and tablet executive dashboards for ERP-Commerce:
...
```
Create a Make scenario for ERP-Commerce that:
...
```
Generate a Make scenario for tenant onboarding in ERP-Commerce:
