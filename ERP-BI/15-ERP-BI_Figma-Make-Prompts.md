...
```
Design a control plane view for ERP-BI that shows:
...
```
Generate a role-aware workspace for ERP-BI with:
...
```
Design a full incident-response flow for ERP-BI:
...
```
Create mobile and tablet executive dashboards for ERP-BI:
...
```
Create a Make scenario for ERP-BI that:
...
```
Generate a Make scenario for tenant onboarding in ERP-BI:
