...
```
Design a control plane view for ERP-Finance that shows:
...
```
Generate a role-aware workspace for ERP-Finance with:
...
```
Design a full incident-response flow for ERP-Finance:
...
```
Create mobile and tablet executive dashboards for ERP-Finance:
...
```
Create a Make scenario for ERP-Finance that:
...
```
Generate a Make scenario for tenant onboarding in ERP-Finance:
