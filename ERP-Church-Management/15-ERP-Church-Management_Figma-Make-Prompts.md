...
```
Design a control plane view for ERP-Church-Management that shows:
...
```
Generate a role-aware workspace for ERP-Church-Management with:
...
```
Design a full incident-response flow for ERP-Church-Management:
...
```
Create mobile and tablet executive dashboards for ERP-Church-Management:
...
```
Create a Make scenario for ERP-Church-Management that:
...
```
Generate a Make scenario for tenant onboarding in ERP-Church-Management:
