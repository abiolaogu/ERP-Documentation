# Projects Architecture Category-King Blueprint

## Architecture Intent

This document defines the System and Service architecture for **Projects** with strict Tenant and Org isolation and scalable Environment promotion.

## Context Diagram

```mermaid
flowchart TD
  U["User"] --> P["Projects Product UI"]
  A["Admin"] --> P
  P --> API["API Gateway"]
