# shared-infra Documentation

## Project Context
This documentation set applies to the **shared-infra** Product and its System boundaries, Services, APIs, Tenant and Org operations across each Environment.
