...
|--------|-------|-------------|
| Health heartbeat | `[env].[org].erp.web-hosting.health` | 30s interval liveness/readiness |
| Error events | `[env].[org].erp.web-hosting.errors` | Application-level errors |
| Metric snapshots | `[env].[org].erp.web-hosting.metrics` | Key business/operational metrics |
