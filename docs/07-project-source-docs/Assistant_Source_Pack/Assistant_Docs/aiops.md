...
|--------|-------|-------------|
| Health heartbeat | `[env].[org].erp.assistant.health` | 30s interval liveness/readiness |
| Error events | `[env].[org].erp.assistant.errors` | Application-level errors |
| Metric snapshots | `[env].[org].erp.assistant.metrics` | Key business/operational metrics |
