# ERP-School-Management Documentation

## Project Context
This documentation set applies to the **ERP-School-Management** Product and its System boundaries, Services, APIs, Tenant and Org operations across each Environment.
