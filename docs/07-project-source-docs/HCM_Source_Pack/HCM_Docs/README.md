# ERP-HCM Documentation

## Project Context
This documentation set applies to the **ERP-HCM** Product and its System boundaries, Services, APIs, Tenant and Org operations across each Environment.
