...
|--------|-------|-------------|
| Health heartbeat | `[env].[org].erp.platform.health` | 30s interval liveness/readiness |
| Error events | `[env].[org].erp.platform.errors` | Application-level errors |
| Metric snapshots | `[env].[org].erp.platform.metrics` | Key business/operational metrics |
