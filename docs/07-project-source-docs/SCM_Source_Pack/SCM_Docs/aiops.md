...
|--------|-------|-------------|
| Health heartbeat | `[env].[org].erp.scm.health` | 30s interval liveness/readiness |
| Error events | `[env].[org].erp.scm.errors` | Application-level errors |
| Metric snapshots | `[env].[org].erp.scm.metrics` | Key business/operational metrics |
