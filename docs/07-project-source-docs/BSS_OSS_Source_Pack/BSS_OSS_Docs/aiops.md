...
|--------|-------|-------------|
| Health heartbeat | `[env].[org].erp.bss-oss.health` | 30s interval liveness/readiness |
| Error events | `[env].[org].erp.bss-oss.errors` | Application-level errors |
| Metric snapshots | `[env].[org].erp.bss-oss.metrics` | Key business/operational metrics |
