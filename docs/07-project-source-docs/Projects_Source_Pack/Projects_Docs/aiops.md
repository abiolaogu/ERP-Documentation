...
|--------|-------|-------------|
| Health heartbeat | `[env].[org].erp.projects.health` | 30s interval liveness/readiness |
| Error events | `[env].[org].erp.projects.errors` | Application-level errors |
| Metric snapshots | `[env].[org].erp.projects.metrics` | Key business/operational metrics |
