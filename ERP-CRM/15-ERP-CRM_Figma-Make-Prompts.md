...
```
Design a control plane view for ERP-CRM that shows:
...
```
Generate a role-aware workspace for ERP-CRM with:
...
```
Design a full incident-response flow for ERP-CRM:
...
```
Create mobile and tablet executive dashboards for ERP-CRM:
...
```
Create a Make scenario for ERP-CRM that:
...
```
Generate a Make scenario for tenant onboarding in ERP-CRM:
