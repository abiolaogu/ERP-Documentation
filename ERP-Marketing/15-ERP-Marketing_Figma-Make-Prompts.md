...
```
Design a control plane view for ERP-Marketing that shows:
...
```
Generate a role-aware workspace for ERP-Marketing with:
...
```
Design a full incident-response flow for ERP-Marketing:
...
```
Create mobile and tablet executive dashboards for ERP-Marketing:
...
```
Create a Make scenario for ERP-Marketing that:
...
```
Generate a Make scenario for tenant onboarding in ERP-Marketing:
