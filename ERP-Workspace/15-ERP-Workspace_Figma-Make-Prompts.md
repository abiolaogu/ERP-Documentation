...
```
Design a control plane view for ERP-Workspace that shows:
...
```
Generate a role-aware workspace for ERP-Workspace with:
...
```
Design a full incident-response flow for ERP-Workspace:
...
```
Create mobile and tablet executive dashboards for ERP-Workspace:
...
```
Create a Make scenario for ERP-Workspace that:
...
```
Generate a Make scenario for tenant onboarding in ERP-Workspace:
